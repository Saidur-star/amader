            ...
            <div class="bbp-meta push-right">
                <div class="more-actions bb-reply-actions bs-dropdown-wrap align-self-center">
                    ...
                    <div class="bs-dropdown-wrap-inner <?php echo esc_attr( $parent_class ); ?>">
						...
						if ( ! $empty ) {
							?>
                            <a href="#" class="bs-dropdown-link bb-reply-actions-button" data-balloon-pos="up" data-balloon="<?php  esc_html_e( 'More actions', 'buddyboss-theme' ); ?>"><i class="bb-icon-menu-dots-v"></i></a>
