	...
	function boss_generate_option_bp_css() {
		...
		<?php ob_start(); ?>
			...
			.bb-groups-messages-left-inner .input:focus + .bp-group-message-slider {
				box-shadow: 0 0 1px <?php echo $accent_color; ?>;
			}
...
if ( !function_exists( 'boss_generate_option_gamipress_css' ) ) {
    function boss_generate_option_gamipress_css() {
        ...
        $accent_color = buddyboss_theme_get_option( 'accent_color' );
        $primary_color	 = buddyboss_theme_get_option( 'body_background' );
		...
		<?php ob_start(); ?>
            ...
            body .gamipress-restrict-content-limiter{
                ...
                background: -webkit-linear-gradient(transparent,<?php echo $primary_color; ?>);
                background: -o-linear-gradient(transparent,<?php echo $primary_color; ?>;
                background: -moz-linear-gradient(transparent,<?php echo $primary_color; ?>);
                background: linear-gradient(transparent,<?php echo $primary_color; ?>);
            }
    ...
    function boss_generate_option_lifterLMS_css() {
		...
		<?php ob_start(); ?>
           ...
           .llms-form-field.type-radio input[type="radio"]:checked + label:before {
                background-image: radial-gradient(ellipse at center,  <?php echo $accent_color; ?> 0%,<?php echo $accent_color; ?> 40%, #fff 45%);
           }
